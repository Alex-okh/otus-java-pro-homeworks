...
public class DataTemplateJdbc<T> implements DataTemplate<T> {
  ...
  public long insert(Connection connection, T client) {
    return dbExecutor.executeStatement(connection, entitySQLMetaData.getInsertSql(), getInsertValues(entityClassMetaData.getFieldsWithoutId(), client));
  }

  @Override
  public void update(Connection connection, T client) {
    dbExecutor.executeStatement(connection, entitySQLMetaData.getUpdateSql(), getUpdateValues(entityClassMetaData.getFieldsWithoutId(), entityClassMetaData.getIdField(), client));
  }
